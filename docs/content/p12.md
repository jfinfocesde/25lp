...
=== "Evaluación de Desempeño 1"
    ...
    *   Manejo de entrada del usuario con `Scanner`.
    ...
    Desarrollar un proyecto en Java utilizando Visual Studio Code y grabar un video con cámara, asegurando un buen sonido, en el que se escriba el código y se explique el ejercicio.
